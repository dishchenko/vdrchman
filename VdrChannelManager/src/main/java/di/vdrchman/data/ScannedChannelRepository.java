...
public class ScannedChannelRepository {
	 ...
	 *            null/zero if not a multistream transponder
	 * @param sid
	...
	public ScannedChannel findBySourceFrequencyPolarizationStreamSidApid(
		...
		p = cb.and(p,
				cb.equal(scannedChannelRoot.get("polarization"), polarization));
		p = cb.and(p, cb.equal(scannedChannelRoot.get("streamId"), streamId));
